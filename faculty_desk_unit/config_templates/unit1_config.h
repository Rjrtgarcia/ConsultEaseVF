...
#define FACULTY_NAME "Dr. John Smith"  // REPLACE WITH ACTUAL FACULTY NAME
...
#define FACULTY_BEACON_MAC "AA:BB:CC:DD:EE:01"  // REPLACE WITH ACTUAL BEACON MAC ADDRESS
